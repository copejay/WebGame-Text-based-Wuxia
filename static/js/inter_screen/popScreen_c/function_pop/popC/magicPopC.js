...
export class magicPopC{
    ...
    create(){
        ...
        this.out_button=new AU_Button(xy[0]+wh[0]*0.9,xy[1]+wh[1]*0.1,wh[0]*0.1,wh[0]*0.1,"X","magicPopC",this.scene);
        ...
        for (let i = 0; i < 3; i++) {
            ...
            this.button_list.push(new AU_Button(x+w*1.2*i,y,w,h,"NULL","magicPopC",this.scene));
    ...
    addListen(){
        ...
        event_bus.on("_magicPopC_click",(click)=>{
            ...
            if (click=="取消"){
                ...
                event_bus.emit("magicPopC_use",this.data[0]);
                this.destroy();
            }
            else if (click=="停止"){
