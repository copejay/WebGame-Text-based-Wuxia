...
export class equipPopC{
    ...
    create(){
        ...
        this.out_button=new AU_Button(xy[0]+wh[0]*0.9,xy[1]+wh[1]*0.1,wh[0]*0.1,wh[0]*0.1,"X","equipPopC",this.scene);
        ...
        for (let i = 0; i < 3; i++) {
            ...
            this.button_list.push(new AU_Button(x+w*1.2*i,y,w,h,"NULL","equipPopC",this.scene));
    ...
    addListen(){
        ...
        event_bus.on("_equipPopC_click",(click)=>{

            console.log(`equipPopC_click${click}`);
            if (click=="取消"){
                this.destroy();
            }
            else if (click=="X"){
                ...
                console.log("magicPopC_use");
                event_bus.emit("equipPopC_use",this.data[0]);
                this.destroy();
            }
            else if (click=="停止"){
                console.log("magicPopC_stop");
                event_bus.emit("magicPopC_stop",this.data[0]);
                this.destroy();
            }
            else if (click=="遗忘"){
                console.log("magicPopC_forget");
                event_bus.emit("magicPopC_forget",this.data[0]);
                this.destroy();
            }
