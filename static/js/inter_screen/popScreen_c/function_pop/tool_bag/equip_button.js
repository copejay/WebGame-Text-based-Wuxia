...
export class AU_Button{
    constructor(x,y,width,height,equip_type,equip_name,own,scene){
        this.x=x;
        this.y=y;
        this.width=width;
        this.height=height;
        ...
        this.own=own;
        // console.log(`equipButton:${this.id}`);
        // console.log(`equipButton${this.equip_name}`);
        // console.log(`equipButton${this.own}`);
        // console.log(`equipButton${this.scene}`);
    ...
    create(){
        ...
        if (this.id.length>=4){
            ...
            if(this.id=="X"){
                ...
                up_text=`【${this.id.slice(0,4)}】`;
            }
            // up_text=`【${this.id.slice(0,6)}】`;
            down_text=`${this.equip_name}`;
        }else{
            up_site_y=0;
            down_site_y=0;
            if(this.id=="X"){
