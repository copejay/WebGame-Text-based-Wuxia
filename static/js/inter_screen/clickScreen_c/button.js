...
export class AU_Button{
    ...
    create(){
        ...
        .on('pointerdown', () => {
            ...
            if(this.mod=="fight"){
                if (this.id=="关闭选项"){
                    ...
                    event_bus.emit("click_fight_magic",this.id);
                }
            }else{
                event_bus.emit("function_click",this.id);
            }
        ...
        // }else if (this.id.length>3){
        //     this.up_text=this.id.slice(0,2);
        //     this.down_text=this.id.slice(2);

        //     this.up_y=-this.height*0.2;
        //     this.down_y=this.height*0.2;
        ...
        this.up_y=-this.width*0.13;
        this.down_y=this.width*0.13;
        // const fight_fontSize=this.width*0.26;


        // this.text_up= this.scene.add.text(0,this.up_y,"",{
        //     fontSize:fight_fontSize,
        //     color:"#fff",
        //     align:'center'
        // });
        // this.text_up.setOrigin(0.5);
        // this.au_button.add(this.text_up);

        // this.text_down= this.scene.add.text(0,this.down_y,"",{
        //     fontSize:fight_fontSize,
        //     color:"#fff",
        //     align:'center'
        // });
        ...
        const x=0;
        const y=0;
        const fontSize=this.width*0.26;
    ...
    re_text(text){
        if (text[0]=="f"){
            ...
            //     this.text_down.setText("");
            //     this.text.setText(text);
            // }else{
            //     this.text.setText("");
            //     this.text_up.setText(text.slice(0,2));
            //     this.text_down.setText(text.slice(2));
            // }
        }
        ...
        if(old_text.length<=3){
            ...
            // this.text_up.setText(old_text.slice(0,2));
            // this.text_down.setText(old_text.slice(2));
        }
        // this.text.setText(text);
    }
